// V2 variant of FruhstuckSection — identical markup, new photo.
export default function FruhstuckV2() {
  return (
    <section className="section bg-beige" id="fruhstuck">
      <div className="split">
        <div className="split-photo">
          <img src="/assets/v2/sections/fruhstuck.jpg" alt="Mediterranes Frühstück im NOYA" data-parallax="0.12" />
