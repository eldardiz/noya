// V2 variant of AboutSection — identical markup, new photos. V1 left untouched.
      ...
      <div className="wrap">
        ...
        <div className="about-grid">
          <div className="about-photos" data-reveal>
            <figure className="p1"><img src="/assets/v2/sections/about-1.jpg" alt="Das NOYA Team" /></figure>
            <figure className="p2"><img src="/assets/v2/sections/about-2.jpg" alt="Gäste im NOYA" /></figure>
            <figure className="p3"><img src="/assets/v2/sections/about-band.jpg" alt="Der Gastraum im NOYA" /></figure>
          </div>
