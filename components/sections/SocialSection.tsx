...
const tiles = [
  { src: '/assets/bar-couple.jpg', likes: '12.4k ♥' },
  { src: '/assets/bar-photo.jpg', likes: '8.1k ♥' },
  { src: '/assets/espresso-machine.jpg', likes: '5.7k ♥' },
  { src: '/assets/silver-teapots.jpg', likes: '19.3k ♥' },
]
