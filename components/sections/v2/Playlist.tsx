...
// V2 Playlist — identical to V1, both streaming buttons clickable.
// NOTE: real NOYA Spotify/Apple playlist URLs still needed — service homepages used as placeholders.
...
export default function PlaylistV2() {
  return (
        ...
        <div className="playlist">
          ...
          <div className="playlist-info">
            ...
            <div className="playlist-actions">
              <a className="btn solid" href={SPOTIFY} target="_blank" rel="noopener noreferrer">Auf Spotify hören ↗</a>
              <a className="cta beige" href={APPLE} target="_blank" rel="noopener noreferrer">Apple Music</a>
            </div>
          </div>
        </div>
      </div>
